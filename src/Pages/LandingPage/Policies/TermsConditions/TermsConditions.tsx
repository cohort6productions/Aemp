  ...
  public render() {
    return (
      <div className="landingPage">
        <HeroSection />
        <div className="cont">
          <h1 className="cont__header">Terms and Conditions</h1>
          <h2 className="cont__subHeader">Overview</h2>
          <p className="cont__paragraph">
            This website is operated by Ambrasia Multimedia Corporation
            (“Ambrasia” or “Ambrasia Multimedia”). Throughout the site, the
            terms “we”, “us” and “our” refer to Ambrasia Multimedia. Ambrasia
            Multimedia offers this website, including all information, tools and
          ...
          <p className="cont__paragraph">
            ...
            limitation users who are browsers, creators, backers and/ or
          ...
          <p className="cont__paragraph">
            ...
            website. Your continued use of or access to the website following
            the posting of any changes constitutes acceptance of those changes.
          </p>
          {/* Section 1 - Online Store Terms */}
          <h3 className="cont__titleHeader">Section 1 - Online Store Terms</h3>
          <p className="cont__paragraph">
            By agreeing to these Terms of Service, you represent that you are at
            least the age of majority in your state, province and/or country of
            residence.
          </p>
          <p className="cont__paragraph">
          ...
          <h3 className="cont__titleHeader">Section 2 - General Conditions</h3>
          <p className="cont__paragraph">
          ...
          <h3 className="cont__titleHeader">
            Section 3 - Accuracy, completeness and timeliness of information
          </h3>
          <p className="cont__paragraph">
            ...
            information, as well as the creators that are presenting projects on
            our site. Any reliance on the material on this site is at your own
            risk.
          </p>
          <p className="cont__paragraph">
          ...
          <h3 className="cont__titleHeader">Section 5 - Optional Tools</h3>
          <p className="cont__paragraph">
          ...
          <h3 className="cont__titleHeader">Section 6 - Third-party links</h3>
          <p className="cont__paragraph">
          ...
          <p className="cont__paragraph">
            If you send certain specific submissions of creative ideas,
            suggestions, proposals, plans, or other materials, whether online,
            by email, by postal mail, or otherwise (collectively, 'comments'),
            you agree that we may, at any time, without restriction, copy,
          ...
          {/* Section 8 - Peronal information */}
          <h3 className="cont__titleHeader">Section 8 - Peronal information</h3>
          <p className="cont__paragraph">
            Your submission of personal information through our website is
            governed by our Privacy Policy as incorporated in this website.
          </p>
          ...
          <p className="cont__paragraph">
            ...
            may relate to creator proposals or other offerings on the site. We
            reserve the right to correct any errors, inaccuracies or omissions,
            and to change or update information or cancel any orders or
            investments if any information in the Service or on any related
            website is inaccurate at any time without prior notice (including
            after you have submitted your order or investment).
          </p>
          {/* Section 10 - Prohibited uses */}
          <h3 className="cont__titleHeader">Section 10 - Prohibited uses</h3>
          <p className="cont__paragraph">
          ...
          <p className="cont__paragraph">
            ...
            kind, either express or implied title, and non-infringement.
          </p>
          <p className="cont__paragraph">
            In no case shall Ambrasia Multimedia, our directors, officers,
          ...
          <h3 className="cont__titleHeader">Section 12 - Indemnification</h3>
          <p className="cont__paragraph">
            You agree to indemnify, defend and hold harmless Ambrasia Multimedia
          ...
          <h3 className="cont__titleHeader">Section 13 - Severability</h3>
          <p className="cont__paragraph">
          ...
          <h3 className="cont__titleHeader">Section 14 - Termination</h3>
          <p className="cont__paragraph">
          ...
          <h3 className="cont__titleHeader">Section 15 - Entire agreement</h3>
          <p className="cont__paragraph">
          ...
          <h3 className="cont__titleHeader">Section 16 - Governing law</h3>
          <p className="cont__paragraph">
            These Terms of Service and any separate agreements whereby we
            provide you Services shall be governed by and construed in
            accordance with the laws of Hong Kong.
          </p>
          {/* Section 17 - Change to term of service */}
          <h3 className="cont__titleHeader">
            Section 17 - Change to term of service
          </h3>
          <p className="cont__paragraph">
